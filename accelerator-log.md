...
```json
{
  "projectName" : "tap-4th-app",
  "repositoryPrefix" : "harbor2.homelab.io/my-project4"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tap-4th-app]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor2.homelab.io/m...(truncated)]
